...
features_folder <- '/home/pgsalome/R/toolbx/organized_folders/NTCP_TCP/clidmeraddos_features/ricci'
...
for (file in feature_files) {
  ...
  for (outcometype in outcome_types) {
    ...
    fsSurv(file, outcomecsv, outcometype, outputDir_md,1000) # Assuming '2' is a fixed parameter in your context
  }
}
